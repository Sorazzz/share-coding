    ...
    <main>
        <div class="hero">
            <div class="hero-text">
                ...
                <h3 class="hero-ttl-ja">IT教育で世界平和を実現する</h3>
            </div>
        </div>
        ...
        <div id="mission">
            <div class="wrapper-1440">
                <div class="mission-wrapper">
                    <div class="section-ttl mission-ttl fade">
                        <h2 class="ttl-en col-white">MISSION</h2>
                        <h3 class="ttl-ja col-white">私たちの使命</h3>
                    </div>
                    <div>
                        <div class="mission-content mission-line fade">
                            <h3 class="ttl-30 mg-b-30">世界平和の実現</h3>
                            <p>人類の悲願である世界平和。世界平和を脅かす様々な社会問題を解決するためには、イノベーションをどんどん起こしていく必要があります。SocialTechは、プログラミング教育を通してイノベーターを輩出することで、世界平和という大きなテーマに挑んでいきます。</p>
                        </div>
                        <div class="mission-content fade">
        ...
        <div id="project" class="pd-tb-120">
            <div class="wrapper-1440">
                <div class="section-ttl fade">
                    <h2 class="ttl-en">PROJECT</h2>
                    <h3 class="ttl-ja">私たちの使命</h3>
                </div>
                <div class="project-wrapper">
                    <div class="project-content mg-b-100 fade">
        ...
        <div id="aboutus" class="pd-tb-120">
            <div class="aboutus-wrapper">
                <div class="aboutus-image fade"></div>
                <div class="section-ttl aboutus-ttl-tablet fade">
                    <h2 class="ttl-en">ABOUT US</h2>
                    <h3 class="ttl-ja">3つの組織文化</h3>
                </div>
                <div class="aboutus-text">
                    <div class="section-ttl aboutus-ttl-pc fade">
                        <h2 class="ttl-en">ABOUT US</h2>
                        <h3 class="ttl-ja">3つの組織文化</h3>
                    </div>
                    <div class="aboutus-content fade">
                        <div class="aboutus-ttl">
                            <h4 class="ttl-num">01</h4>
                            <h3 class="ttl-30">フレキシブル</h3>
                        </div>
                        <p>リモートワーク、フルフレックス、副業推奨など1人1人が最大限のパフォーマンスを発揮できる柔軟な働き方を促進しています。</p>
                    </div>

                    <span class="aboutus-line fade"></span>

                    <div class="aboutus-content fade">
                        <div class="aboutus-ttl">
                            <h4 class="ttl-num">02</h4>
        ...
        <div id="vision" class="pd-tb-120">
            <div class="wrapper-1440">
                <div class="section-ttl fade">
                    ...
                    <h3 class="ttl-ja col-white">7つの行動指針</h3>
                </div>
                <div class="vision-content">
                    <div class="vision-item mg-rb-30 fade">
                        <p class="ttl-num-2">01</p>
                        <div class="vision-ttl">
                            <h4 class="ttl-en-s">CUSTOMER IS BOSS</h4>
                            <h3 class="ttl-30">あなたのボスは顧客である</h3>
                        </div>
                        <p>私たちは常にお客様志向で行動し、お客様を喜ばせ、期待値を超えた感動を提供することを大切にします。</p>
                    </div>

                    <div class="vision-item mg-b-30 fade">
                        <p class="ttl-num-2">02</p>
                        <div class="vision-ttl">
                            <h4 class="ttl-en-s">MOVE FAST</h4>
                    ...
                    <div class="vision-item mg-rb-30 fade">
                        ...
                        <div class="vision-ttl">
                            <h4 class="ttl-en-s">IMPACT DRIVEN</h4>
                    ...
                    <div class="vision-item mg-b-30 fade">
                        ...
                        <div class="vision-ttl">
                            <h4 class="ttl-en-s">SAVE TIME, SAVE MONEY</h4>
                    ...
                    <div class="vision-item mg-rb-30 fade">
                        ...
                        <div class="vision-ttl">
                            <h4 class="ttl-en-s">BE GENTLE</h4>
                    ...
                    <div class="vision-item mg-b-30 fade">
                        ...
                        <div class="vision-ttl">
                            <h4 class="ttl-en-s">ABC</h4>
                            <h3 class="ttl-30">当たり前の事をバカにせずにちゃんとやる</h3>
                        </div>
                        <p>礼儀、健康、嘘をつかない。当たり前の事が出来ているかを常に自問し、当たり前の基準を高く持って行動します。</p>
                    </div>

                    <div class="vision-item fade">
                        <p class="ttl-num-2">07</p>
                        <div class="vision-ttl">
                            <h4 class="ttl-en-s">ZTI</h4>
        ...
        <div id="company" class="pd-tb-120">
            <div class="wrapper-1440">
                <div class="section-ttl fade">
                    ...
                    <h3 class="ttl-ja">会社概要</h3>
                </div>
                <div class="company-wrapper">
                    <table class="company-info fade">
                        <tr>
                            <th>会社名</th>
